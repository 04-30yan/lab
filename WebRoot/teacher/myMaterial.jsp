...
<script type="text/javascript">
	...
	$(function(){
		$("#teacher_myMaterial_datagrid").datagrid({
			...
			toolbar:'#teacher_myMaterial_toolbar'
		});
	});
		...
		$.messager.confirm('请确认!','你确定要删除该资料吗?',function(data){
			if(data){
				$.ajax({
					...
					success:function(d){
						if(d){
							$('#teacherOwn_material_datagrid').datagrid('load');
							$.messager.show({
								title:'提示',
								msg:'恭喜你,删除成功!'
							});
	...
	//上传
	function teacher_myMaterial_upload(){
...
<div id="teacher_myMaterial_toolbar" style="height:28px;border-bottom:1px solid #F3F3F3">
	<div style="margin-top:2px;">
		<a onclick="teacher_myMaterial_upload();" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">资料上传</a>
	</div> 
</div>
