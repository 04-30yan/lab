...
public class MaterialService {
	...
	public Map<String,Object> getMaterial(Material mt){
		...
		String sql = "SELECT material.id,material.title,material.url,user.userName,material.addTime " +
	...
	public boolean addMaterial(String uploadFileName, String name,
			String dstPath, String userId) {
		boolean b = false;
		Connection conn = null;
		PreparedStatement ps = null;
		String sql = "insert into material(title,url,userId,addTime) value(?,?,?,?)";
