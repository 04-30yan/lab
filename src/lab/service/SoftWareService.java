...
public class SoftWareService {
	...
	public Map<String ,Object> getSoftWare(SoftWare sw){
		...
		String sql = "select softWare.id,softWare.name,softWare.addTime,softWare.url,softWare.userId,user.userName " +
	...
	public boolean addSoftWare(String userId, String uploadFileName,
		...
		Connection conn = null;
		PreparedStatement ps = null;
		String sql = "insert into softWare(userId,name,url,addTime) value(?,?,?,?)";
